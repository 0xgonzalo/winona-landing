        ...
        <div className="relative z-10 flex flex-1 items-center justify-center px-4 py-8">
          <div className="w-full max-w-6xl flex flex-col-reverse md:flex-row gap-8 md:gap-16">
            <div className="flex flex-col items-center w-full max-w-md mx-auto md:mx-0">
              <div className="bg-black text-white rounded-2xl shadow-lg p-8 w-full md:min-w-sm flex flex-col justify-center border border-gray-700">
                <h2 className="text-2xl font-sans mb-6">Contacto</h2>
                <RegistroPage />
              </div>
